...
export function deterministicEditorialEdition(issue: RssIssue, candidates: CandidateStory[], profile: Profile): Edition {
  ...
  return {
    ...
    issue: {
      ...
      coverage: "Qualified signals in the collector-selected source window",
      url: issue.url,
